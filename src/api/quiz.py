...
async def submit_quiz(
    ...
    # pass the quiz data to the health calculation functions to compute BMI, BMR, and TDEE based on the user's input.
    bmi = calculate_bmi(quiz_data.weight_lbs, quiz_data.height_in)
    bmr = calculate_bmr(quiz_data.weight_lbs, quiz_data.height_in, quiz_data.age, quiz_data.gender)
    ...
    goal = FitnessGoal(
        ...
        height_in=quiz_data.height_in,   
        weight_lbs=quiz_data.weight_lbs, 
        target_weight=quiz_data.target_weight,
        activity_level=quiz_data.activity_level,
        workout_days=quiz_data.workout_days,
        dietary_preferences=quiz_data.dietary_preferences,
        allergies=quiz_data.allergies,
...
async def update_quiz(
    ...
    goal.height_in = quiz_data.height_in   
    goal.weight_lbs = quiz_data.weight_lbs 
    ...
    goal.dietary_preferences = quiz_data.dietary_preferences
    goal.allergies = quiz_data.allergies
